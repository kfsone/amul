#ifndef AMUL_FILEMAPPING_H
#define AMUL_FILEMAPPING_H
#pragma once
...
error_t NewFileMapping(string_view filepath, void **datap, size_t *sizep) noexcept;
...
class FileMappingImpl
{
  ...
  public:
    ...
    FileMappingImpl(string_view filepath) noexcept : m_filepath(filepath) {}
