...
public:
    ...
    constexpr Demon(demonid_t id, slot_t owner, time_t trigger,
                     verbid_t action, Param param1, Param param2)
        : m_id{ id }
        , m_owner{ owner }
        , m_trigger{ trigger }
        , m_action{ action }
        , m_params{ param1, param2 }
    {}
    ~Demon();
    ...
    static demonid_t Start(slot_t owner, time_t seconds, verbid_t action, Param param1, Param param2);
