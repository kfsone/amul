...
warnings="-Wconversion-null  -Wctor-dtor-privacy -Wdelete-non-virtual-dtor  -Wliteral-suffix  -Wmultiple-inheritance -Wnamespaces  -Wnarrowing -Wnoexcept  -Wnoexcept-type  -Wnon-virtual-dtor  -Wreorder  -Wregister -Wstrict-null-sentinel -Wno-non-template-friend  -Woverloaded-virtual  -Wno-pmf-conversions -Wsign-promo  -Wvirtual-inheritance -Wshadow -Wsequence-point -Wuseless-cast"
...
compiler_flags="-DDEBUG -std=c++17 -O0 -g3 -Wall -Wpedantic -Wcast-qual -Wwrite-strings -Wmissing-declarations $warnings $sanitizer"
