...
#define STATE_STD_FLAGS (bob_DEATH | bob_LIT | bob_SILENT | bob_PEACEFUL | bob_SCALED)
...
enum { PUT_IN, PUT_ON, PUT_BEHIND, PUT_UNDER };
...
// Spells
enum { SGLOW = 1, SINVIS, SBLIND, SCRIPPLE, SDEAF, SDUMB, SSLEEP, SSINVIS };
...
// Anouncement types
enum { AGLOBAL, AEVERY1, AOUTSIDE, AHERE, AOTHERS, AALL, ACANSEE, ANOTSEE };
...
enum RDMode {
    RDRC,
    RDVB,
    RDBF  // RoomCount, VerBose, BrieF
};

// Description modes
enum DMode { TYPEV, TYPEB };
