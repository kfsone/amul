...
#    define NRFLAGS 15
#    define NRNULL 1
char *rflag[NRFLAGS] = /* Remember to update amul.defs.h */
        {"light",  "dmove",  "startloc", "randobjs",  "dark",     "small",    "death",
         "nolook", "silent", "hide",     "sanctuary", "hideaway", "peaceful", "noexits"};

#    define NOFLAGS 8
char *obflags1[NOFLAGS] = {"opens",  "scenery", "counter", "flamable",
                           "shines", "fire",    "invis",   "smell"};

#    define NOPARMS 5
char *obparms[NOPARMS] = {"adj=", "start=", "holds=", "put=", "mobile="};

#    define NSFLAGS 7
char *obflags2[NSFLAGS] = {"lit", "open", "closed", "weapon", "opaque", "scaled", "alive"};
#endif

#ifndef AMAN
#    define NPUTS 4
char *obputs[NPUTS] = {"In", "On", "Behind", "Under"};

#    define NPREP 6
char *prep[NPREP] = {"in", "on", "behind", "under", "from", "with"};
#endif
...
#ifdef COMPILER
char *conds[NCONDS] = {"&",          "-",         "else",   "always",     "light",     "ishere",
                       "myrank",     "state",     "mysex",  "lastverb",   "lastdir",   "lastroom",
                       "asleep",     "sitting",   "lying",  "rand",       "rdmode",    "onlyuser",
                       "alone",      "inroom",    "opens",  "gotnothing", "carrying",  "nearto",
                       "hidden",     "cangive",   "infl",   "inflicted",  "sameroom",  "someonehas",
                       "toprank",    "gota",      "active", "timer",      "burns",     "container",
                       "empty",      "objsin",    "->",     "&>",         "helping",   "gothelp",
                       "givinghelp", "else>",     "stat",   "objinv",     "fighting",  "taskdone",
                       "cansee",     "visibleto", "noun1",  "noun2",      "autoexits", "debug",
                       "full",       "time",      "dec",    "inc",        "lit",       "fire",
...
#ifdef COMPILER
#    define nsynts 12
char *    syntax[nsynts] = {"none", "any", "noun", "adj",  "prep",  "player",
                        "room", "syn", "text", "verb", "class", "number"};
short int syntl[nsynts] = /* Length of --^ */
        {4, 3, 4, 3, 4, 6, 4, 3, 4, 4, 5, 6};
#endif

char advfn[] = "Prof.CMP";   /* Game profile	*/
char rooms2fn[] = "RDs.CMP"; /* Descriptions	*/
#ifndef COMPILER
char mannam[] = "AMUL Manager Port"; /* MU driver port */
char plyrfn[] = "Players Data";      /* User Details	*/
#endif
#ifndef FRAME
char rooms1fn[] = "Rms.CMP"; /* Room blocks	*/
char ranksfn[] = "Rks.CMP";  /* Rank details	*/
char ttfn[] = "TT.CMP";      /* T.T. Entries	*/
char ttpfn[] = "TTP.CMP";    /* TT Paramtrs	*/
char lang1fn[] = "Vbs.CMP";  /* Verb blocks	*/
char lang2fn[] = "ST.CMP";   /* Slot Tables	*/
char lang3fn[] = "VT.CMP";   /* Verb Table	*/
char lang4fn[] = "VTP.CMP";  /* VT Parms	*/
char synsfn[] = "Syns.CMP";  /* Synonyms	*/
char synsifn[] = "SynI.CMP"; /* Syns Index	*/
char ntabfn[] = "Ntb.CMP";   /* Noun table	*/
char obdsfn[] = "Ods.CMP";   /* Object descs	*/
char objsfn[] = "Obs.CMP";   /* Detail!!!	*/
char objrmsfn[] = "Ors.CMP"; /* Object rooms	*/
char statfn[] = "Oss.CMP";   /* Obj. States	*/
char adjfn[] = "Adjs.CMP";   /* Adjectives	*/
char umsgifn[] = "UMI.CMP";  /* UMsgs Index	*/
