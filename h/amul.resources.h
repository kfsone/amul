...
namespace Compiled
{
    ...
    static inline const char *travelParams() noexcept { return "travelparams" COMPILED_SUFFIX; }
    ...
    static inline const char *umsgIndex() noexcept { return "umsgindex" COMPILED_SUFFIX; }
    static inline const char *umsgData() noexcept { return "umsgdata" COMPILED_SUFFIX; }
}  // namespace Compiled
}  // namespace Resources
