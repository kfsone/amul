...
char 	*rflag[NRFLAGS]=	/* Remember to update amul.defs.h */
{
	...
	"silent","hide","sanctuary","hideaway","peaceful","noexits"
};
...
char	*acts[NACTS]=
{
	...
	"look",		"what",		"where",	"who",
	"treatas",	"message",	"skip",		"endparse",
	"killme",	"finishparse",	"abortparse",	"failparse",
	"wait",		"bleep",	"whereami",	"send",
	"announce",	"get",		"drop",		"invent",
	"reply",	"changesex",	"sleep",	"wake",
	"sit",		"stand",	"lie",		"rdmode",
	"reset",	"action",	"move",		"travel",
	"announceto",	"actionto",	"announcefrom",	"actionfrom",
	"tell",		"addval",	"give",		"inflict",
	"cure",		"summon",	"add",		"sub",
...
char	tacp[NACTS][3]=		/* Type of params... */
{
	...
	PUMSG,0,0,	PPLAYER,0,0,	NONE,		NONE,
	...
	PNOUN,0,0,	PNOUN,0,0,	PNOUN,0,0,	NONE,
